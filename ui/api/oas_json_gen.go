...
// Encode implements json.Marshaler.
func (s *UpdateBooking) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *UpdateBooking) encodeFields(e *jx.Encoder) {
	{
		if s.Event.Set {
			e.FieldStart("event")
			s.Event.Encode(e)
...
var jsonFieldsNameOfUpdateBooking = [3]string{
	0: "event",
	1: "date",
	2: "status",
}

// Decode decodes UpdateBooking from json.
func (s *UpdateBooking) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode UpdateBooking to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode UpdateBooking")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *UpdateBooking) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *UpdateBooking) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfUpdateUser = [3]string{
	0: "name",
	1: "email",
	2: "password",
}
