...
func decodeBookingsBookingIdDeleteResponse(resp *http.Response) (res BookingsBookingIdDeleteRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &BookingsBookingIdDeleteNoContent{}, nil
	case 404:
		// Code 404.
		return &BookingsBookingIdDeleteNotFound{}, nil
	}
...
func decodeUsersUserIdPutResponse(resp *http.Response) (res UsersUserIdPutRes, _ error) {
	...
	case 404:
		// Code 404.
		return &UsersUserIdPutNotFound{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
